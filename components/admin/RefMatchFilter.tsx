        ...
        <Dialog as="div" className="relative z-10" onClose={handleCancel}>
          <div className="fixed inset-0">
            <div className="relative">
              ...
              >
                <Dialog.Panel className="absolute right-4 top-2 z-60 mt-2 w-96 origin-top-right rounded-md bg-white p-4 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
