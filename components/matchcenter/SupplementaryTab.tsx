          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[1, 2].map((refNumber) => {
              ...
              const passNo = match.supplementarySheet?.[passNoKey] as
                | string
                | undefined;
              const delayMin = match.supplementarySheet?.[delayMinKey] as
                | number
                | undefined;
              ...
              return (
                <InfoCard
                  ...
                  className={
                    isDifferentReferee
                      ? "border-red-600 border-2 shadow-red-500/50 shadow-lg"
                      : ""
                  }
                  footer={
                    isDifferentReferee ? (
                      <div className="text-xs text-gray-600">
                        ...
                        <div className="text-sm text-gray-800">
                          {assignment.referee.firstName}{" "}
                          {assignment.referee.lastName}
                        </div>
              ...
              <div className="text-sm text-gray-700 space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {match.supplementarySheet?.timekeeper1?.firstName ||
                    match.supplementarySheet?.timekeeper1?.lastName
            ...
            <InfoCard title="Zeitnehmer 2">
              <div className="text-sm text-gray-700 space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-600">Name:</span>
                  <span className="font-medium">
                    {match.supplementarySheet?.timekeeper2?.firstName ||
                    match.supplementarySheet?.timekeeper2?.lastName
            ...
            <InfoCard title="Technischer Direktor">
              <div className="text-sm text-gray-700 space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-600">Name:</span>
                  <span className="font-medium">
                    {match.supplementarySheet?.technicalDirector?.firstName &&
                    match.supplementarySheet?.technicalDirector?.lastName
