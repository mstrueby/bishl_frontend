...
interface TeamChangeConfirmDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  isLoading: boolean;
...
const TeamChangeConfirmDialog: React.FC<TeamChangeConfirmDialogProps> = ({
  isOpen,
  onClose,
  onConfirm,
  isLoading,
      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform rounded-lg bg-white shadow-xl transition-all">
                <div className="p-6">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-2 text-sm text-gray-600 space-y-2">
                        <p>
                          ...
                          wird dauerhaft von{" "}
                          <span className="font-medium text-gray-900">{fromTeamName}</span>{" "}
                          zu{" "}
...
export default TeamChangeConfirmDialog;
