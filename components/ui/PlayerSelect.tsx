      ...
      {({ open }) => (
        <>
          ...
          <div className="relative">
            <Listbox.Button className={`relative w-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ${error ? 'ring-red-300' : 'ring-gray-300'} focus:outline-none focus:ring-2 ${error ? 'focus:ring-red-500' : 'focus:ring-indigo-500'} sm:text-sm sm:leading-6`}>
              {selectedPlayer ? (
