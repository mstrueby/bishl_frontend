...
const FormikPlayerSelect = forwardRef<PlayerSelectHandle, PlayerSelectProps>(({
  name,
...
const StandalonePlayerSelect = forwardRef<PlayerSelectHandle, PlayerSelectProps>(({
  name,
  selectedPlayer: propSelectedPlayer,
  onChange,
  roster,
...
const PlayerSelect = forwardRef<PlayerSelectHandle, PlayerSelectProps>((props, ref) => {
  const formikContext = useFormikContext();
  const isInFormikContext = !!formikContext;

  if (isInFormikContext) {
    return <FormikPlayerSelect {...props} ref={ref} />;
  } else {
    return <StandalonePlayerSelect {...props} ref={ref} />;
  }
});

FormikPlayerSelect.displayName = 'FormikPlayerSelect';
StandalonePlayerSelect.displayName = 'StandalonePlayerSelect';
