...
const MyListbox = ({ label, name, options, ...props }: ListboxProps) => {
  ...
  const [selected, setSelected] = useState<ListboxOption>(options[0]);
  ...
  return (
    ...
    >
      {({ open }) => (
        <div>
          <Listbox.Label className="block mt-6 mb-2 text-sm font-medium text-gray-700">{label}</Listbox.Label>
